...
describe('Vladilen Promise: ', () => {
  ...
  beforeEach(() => {
    ...
    promise = new CorePromise(executorSpy)
  })

  test('should exists and to be typeof function', () => {
    expect(CorePromise).toBeDefined()
    expect(typeof CorePromise).toBe('function')
  })
  ...
  test('should catch error', () => {
    ...
    const errorPromise = new CorePromise(errorExecutor)
